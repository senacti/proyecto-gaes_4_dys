...
Id_Factura int not null IDENTITY(1000,1) primary key,
Fecha date,
Cliente int,
...
Id_Categoria int not null IDENTITY(10,1) primary key,
...
create table Ventas(
Id_Venta int not null IDENTITY(2000,1) primary key,
...
id_Reporte int not null identity(47637736,1) primary key,
...
Id_Pedido int not null identity(101083562,1) primary key,
...
Id_Domicilio int not null IDENTITY(26377736,1) primary key,
